...
module.exports.smartConfigHandler = async () => {
	return {
		"authorization_endpoint": 'https://' + process.env.AUTH0_ORG + '/authorize',
		"token_endpoint": process.env.GATEWAY_URL + '/token',
		"token_endpoint_auth_methods_supported": ["client_secret_basic"],
		"registration_endpoint": 'https://' + process.env.AUTH0_ORG + '/oidc/register',
		"scopes_supported": ["openid", "profile", "launch", "launch/patient", "patient/*.*", "user/*.*", "offline_access"],
		"response_types_supported": ["code", "code id_token", "id_token", "refresh_token"],
		"introspection_endpoint": 'https://' + process.env.AUTH0_ORG + '/oauth/introspect',
		"revocation_endpoint": 'https://' + process.env.AUTH0_ORG + '/oauth/revoke',
			...
			"extension" : [
			  {
				"extension" : [
				  ...
				  {
					"url" : "authorize",
					"valueUri" : 'https://' + process.env.AUTH0_ORG + '/authorize'
				  },

				  {
					"url" : "introspect",
					"valueUri" : 'https://' + process.env.AUTH0_ORG + '/oauth/introspect'
				  },
				  {
					"url" : "revoke",
					"valueUri" : 'https://' + process.env.AUTH0_ORG + '/oauth/revoke'
				  },
				  {
					"url" : "register",
					"valueUri" : 'https://' + process.env.AUTH0_ORG + '/oidc/register'
				  }
				],
